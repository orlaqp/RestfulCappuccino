...
## Extra goodies
	...
	Just create a temporal controller on your rails app so you do not have to create your models manually. So far I am only dealing 
	with string, integer and datetime, but as you can see is easy to add the rest of the data types.
